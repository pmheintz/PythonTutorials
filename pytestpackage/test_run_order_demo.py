"""
Setting order in which pytest tests run
requires pytest-ordering 'pip3 install pytest-ordering'
More info: https://pytest-ordering.readthedocs.io/en/develop/
"""

import pytest

@pytest.mark.run(order=2) # These annotations set the run order
